...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-left">
          ...
          <a class="navbar-brand" href="{{ route('welcome') }}">
            ...
            <h5 class="logo-light" style="{{ 'font-weight:200px' }}">Z-Reader</h5>
            <h5 class="logo-dark" style="{{ 'font-weight:200px'}}">Z-Reader</h5>
          </a>
        </div>
    ...
    <!-- Footer -->
    <footer class="footer" style="background: #efedef;">
      <div class="container">
